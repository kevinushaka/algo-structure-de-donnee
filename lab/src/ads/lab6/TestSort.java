...
public class TestSort extends TestClass<TestSort> {
    ...
    public TestSort() {
        ...
        array[0]=new SlowInteger(23);
        array[1]=new SlowInteger(2);
        array[2]=new SlowInteger(43);
        array[3]=new SlowInteger(34);
        array[4]=new SlowInteger(17);
        array[5]=new SlowInteger(45);
        array[6]=new SlowInteger(12);
        array[7]=new SlowInteger(25);
