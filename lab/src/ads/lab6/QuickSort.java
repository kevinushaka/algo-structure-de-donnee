...
public class QuickSort {
     ...
     */
    private static <AnyType extends Comparable<AnyType>> void partition(AnyType[] array, int lo, int hi) {
     ...
     */
    private static <AnyType extends Comparable<AnyType>> void median(AnyType[] array, int lo, int mid, int hi) {
