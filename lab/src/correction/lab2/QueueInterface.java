...
public interface QueueInterface<AnyType> {
     ...
     */
    public AnyType peek() throws EmptyQueueException, correction.lab2.EmptyQueueException;
     ...
     * If the queue is empty throws EmptyQueueException
     */
    public AnyType dequeue() throws EmptyQueueException, correction.lab2.EmptyQueueException;
}